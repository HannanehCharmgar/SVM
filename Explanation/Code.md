...
## AP (Average Precision): 0.668

این معیار برای ارزیابی مدل‌هایی استفاده می‌شود که کلاس‌ها نامتعادل هستند؛
برای مثال در این مسئله، احتمالاً تعداد افراد غیردیابتی بیشتر از بیماران دیابتی است.

منحنی Precision–Recall نشان می‌دهد که با افزایش Recall، مقدار Precision کاهش پیدا می‌کند که رفتاری طبیعی در این نوع مسائل است.

این موضوع بیانگر آن است که عملکرد مدل در شرایطی که کلاس مثبت کم‌تعداد است (بیماران)، کمی ضعیف‌تر از عملکرد آن در معیار AUC می‌باشد.
...
- Recall بالا → مدل بیشتر بیماران را به‌درستی شناسایی می‌کند (نکته‌ای بسیار مهم در کاربردهای پزشکی)

## نقاط ضعف مدل

- Precision پایین → مدل خطای مثبت زیادی دارد (افراد سالم را بیمار تشخیص می‌دهد)

- F1-Score متوسط → نشان‌دهنده‌ی عدم تعادل بین دقت (Precision) و حساسیت (Recall)
