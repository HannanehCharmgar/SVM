...
rue Negative (TN) = 74 → مواردی که واقعاً دیابت نداشتند و مدل درست تشخیص داده.
...
. نمودار سمت راست: Probability Distribution - Box Plot
محورهای نمودار:
...
⚠️این جعبه‌ها نشان می‌دهند که توزیع احتمال‌ها برای دو کلاس همپوشانی دارد — یعنی مدل نمی‌تواند به طور کامل این دو کلاس را از هم جدا کند. این هم‌پوشانی دلیل اصلی خطاهای طبقه‌بندی است.
