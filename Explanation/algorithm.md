...
در الگوریتم ماشین بردار پشتیبان و برای تعیین مرز جداسازی، تنها نزدیک‌ترین نقاط داده یا همان «بردارهای پشتیبان» به ابر صفحه اهمیت دارند. اما در [رگرسیون لجستیک](https://github.com/HannanehCharmgar/Logistic_Regression)
، برای تعیین دسته‌بند، به تمام نقاط داده نیاز است. یک راه‌حل منطقی، انتخاب ابر صفحه‌ای است که بیشترین جدایی یا حاشیه را میان دو کلاس ایجاد کند.
